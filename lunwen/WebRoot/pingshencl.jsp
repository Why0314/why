...
{
	rs=sta.executeQuery("select *  from paper  where fabushijian like '%"+request.getParameter("key")+"%'");
...
request.getRequestDispatcher("pingshen.jsp").forward(request,response);
