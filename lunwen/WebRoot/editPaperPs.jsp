<%
	...
	response.sendRedirect("indexPs.jsp");
	}
 %>
...
<div style="width:100%; background-image:url('image/beijing4.jpg')">
	<center>
		...
		<form method="post"  action="updatePaperPs.jsp">
			...
			<table border="1">
				...
				<tr>
					<td>简介</td>
					<td><input type="text" disabled="true" name="jianjie" value="<%=u.getJianjie() %>"/></td>
				</tr>
			<tr>
					<td>时间</td>
					<td><input type="text" disabled="true" name="shijian" value="<%=u.getShijian() %>"/></td>
				</tr>
				<tr>
					<td>内容</td>
					<td><input type="text" disabled="true" name="neirong" value="<%=u.getNeirong() %>"/></td>
				</tr>
				<tr>
					<td>评分</td>
					<td><input type="text" name="chengji" value="<%=u.getChengji() %>"/></td>
				</tr>
				<tr>
